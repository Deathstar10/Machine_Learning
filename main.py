...
base_model = ResNet50(include_top=False, weights=None,input_tensor=img_input, input_shape=img_size, pooling=max)
...
model.add(tf.keras.layers.Flatten(input_shape=(150, 150)))
